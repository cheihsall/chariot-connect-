            ...
            <nav class="-mx-3 space-y-6 ">
              ...
              <div className=" bttn">
                ...
                <Link to="ajouterproduit">
                  ...
                  <button class="text-white transition-colors duration-3000 transform px-3 py-2 bg-emerald hover:bg-[#FEBC11] hover:text-white py-3  w-55 h-12 font-medium rounded-lg drop-shadow-lg flex flex-row">
                ...
                <div class="space-y-3 ">
                  ...
                  <Link to="ajoutercaissier">
                    ...
                    data-bs-target="#modalRegister" class="text-white transition-colors duration-3000 transform px-3 py-2 bg-emerald hover:bg-[#FEBC11] hover:text-white py-3  w-55 h-12 font-medium rounded-lg drop-shadow-lg flex flex-row gap-2">
                      <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z"></path>
                      </svg>
              ...
              <div class=" ">
                ...
                <button onClick={() => logout()} class="text-white transition-colors duration-3000 transform px-3 py-2 bg-emerald hover:bg-[#FEBC11] hover:text-white py-3  w-55 h-12 font-medium rounded-lg drop-shadow-lg flex flex-row gap-2">
                  ...
                  <span class="mx-2 text-sm font-medium"  >Deconnexion</span>
                </button>
